...
CREATE INDEX IF NOT EXISTS idx_ai_command_history_admin ON ai_command_history(admin_id);
CREATE INDEX IF NOT EXISTS idx_ai_command_history_created ON ai_command_history(created_at);
CREATE INDEX IF NOT EXISTS idx_ai_command_history_action ON ai_command_history(action);
...
CREATE INDEX IF NOT EXISTS idx_ai_audit_logs_admin ON ai_audit_logs(admin_id);
